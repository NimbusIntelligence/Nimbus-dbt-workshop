...
8. En la barra de comandos, ejecuta el siguiente comando:
   ...
   para crear el modelo parts_per_set en nuestro data warehouse (esto deberia fallar).
...
19. En la barra de comandos, ejecuta el comando
    ...
    para crear y probar todos los modelos en nuestro data warehouse (esto deberia fallar).
...
20. En la barra de comandos, ejecuta el comando
    ...
    para probar todos los modelos (esto deberia fallar)

22. Edita el archivo my_first_dbt_model.sql en el directorio de ejemplo (/models/example/my_first_dbt_model.sql) para eliminar el comentario en la línea 27.
...
23. En la barra de comandos, ejecuta el comando:
...
24. Actualiza el archivo sources.yml en el directorio lego (/models/lego/sources.yml) copiando y pegando la versión completa.
...
27. Haz clic en el pequeño ícono de documento para ver la documentación

    ![docs icon](../imagenes/icono_docs.png)

28. Haz clic en "Commit and sync" en control de versiones e ingresa un mensaje de commit en el cuadro de diálogo.
