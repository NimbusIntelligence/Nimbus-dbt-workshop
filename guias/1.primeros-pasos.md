...
2. Haz clic en “Commit and sync” en el control de versiones e introduce un mensaje de commit inicial en el cuadro de diálogo
...
10. En la barra de comandos, ejecuta el siguiente comando:
    ...
    para crear todos los modelos en la carpeta lego en nuestro almacén de datos
...
19. En la barra de comandos, ejecuta el comando
    ...
    para crear y probar todos los modelos en nuestro almacén de datos
...
22. En la barra de comandos, ejecuta el comando:
    ...
    Para crear y probar todos los modelos en nuestro almacén de datos, asegurándote de que todos pasen:

23. Actualiza el archivo sources.yml en el directorio lego (/models/lego/sources.yml) copiando y pegando la versión completa desde el fileshare.
...
24. En la barra de comandos, ejecuta el comando
    ...
    para crear y luego probar todos nuestros modelos de forma secuencial en el almacén de datos
