...
4. Crea un archivo schema.yml en el directorio office_weather ("/models/office_weather/schema.yml") y copia/pega el siguiente YAML.
...
8. Actualiza el archivo dbt_project.yml ("/dbt_project.yml") para materializar todo lo de la carpeta office_weather como una vista por defecto.
   ...
   <details>
   <summary>dbt_project.yml completo</summary>
