...
5. Actualiza customers_with_late_fees.sql para que utilice las fuentes definidas (sources) en lugar de los valores codificados directamente.
    ...
    <details>
    <summary>Pista</summary>
    Usa el jinja adecuado para insertar tus fuentes en el SQL
    puedes usar el comando __sources para obtener la estrcutura jinja adecuada
    </details>
...
11. Crea un archivo schema.yml de library_loans, toma las pruebas de members (líneas 26-33) del sources.yml y aplícalas al nuevo stg_members dentro de un bloque de models.
