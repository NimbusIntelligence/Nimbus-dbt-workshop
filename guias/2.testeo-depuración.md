...
2. Crea un nuevo archivo en la carpeta library_loans llamado customers_with_late_fees.sql (/models/library_loans/customers_with_late_fees.sql) y copia/pega dentro de él el SQL del archivo inicial customers_with_late_fees.sql.
...
3. Crea un archivo schema.yml en la carpeta library_loans (/models/library_loans/schema.yml) y copia/pega en él el contenido del archivo inicial schema.yml.
...
5. Actualiza customers_with_late_fees.sql para que utilice las fuentes definidas (sources) en lugar de los valores codificados directamente (hardcoded).
...
10. Copia el SQL del archivo inicial stg_members.sql
...
14. Copia el SQL del archivo inicial stg_books.sql en el nuevo modelo.
...
20. Copia el SQL del archivo inicial stg_loans.sql dentro del nuevo modelo.
...
29. Copia en el archivo no_negative_values.sql el contenido del archivo inicial no_negative_values.sql.
...
35. Crea solution.csv en la carpeta seeds ("/seeds/solution.csv")

36. Abre el archivo inicial solution.csv en un editor de texto y copia su contenido en /seeds/solution.csv.

    <details>
    <summary>contenido de solucion.csv</summary>

    [solution.csv](../archivos/solucion.csv)

    </details>

37. Actualiza el archivo schema.yml en la carpeta library_loans ("/models/library_loans/schema.yml") para añadir una sección seeds al final del archivo con el nombre solution.
...
39. Actualiza el archivo schema.yml en la carpeta library_loans ("/models/library_loans/schema.yml") para agregar el test [dbt_utils.equal_rowcount](https://github.com/dbt-labs/dbt-utils/tree/1.3.0/#equal_rowcount-source) al modelo customers_with_late_fees, comparándolo con el seed solution.
